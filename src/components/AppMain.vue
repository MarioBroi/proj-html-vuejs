...
<template>
    <main class="site-main">
        ...
        <div class="bg-light">
            ...
            <section class="upgrade container bg-light">
                ...
                <div class="upgrade-top">
                    ...
                    <div class="upgrade-rigth">
                        ...
                        <p>Opening up more opportunities in front of you to get the ticket to more enjoyable door in
                            life.
                            Getting equipped with new skills for new sets of insights into your career. MaxCoach
                            accompany
            ...
            <section class="online container">
                ...
                <h1>Latest Online <span class="important-text">Courses</span></h1>

                <div class="carousell">

                    <div class="col">
                        <div class="card">
                            <img src="/public/img/course-02-480x298.jpg" alt="">
                            <div class="card-content">
                                <div class="online-price">$40.00</div>
                    ...
                    <div class="col">
                        <div class="card">
                            ...
                            <div class="card-content">
                                <div class="online-price">$19.00</div>
                ...
                <div class="online-bottom">
                    <p>
                        Control your personal preference setting to get notified about appropiate courses.
